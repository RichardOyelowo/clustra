...
async def create_activity(org_id: uuid.UUID, data: ActivityCreate, db: AsyncSession = Depends(db_session)) -> ActivityResponse:
    pass
...
async def edit_activity(org_id: uuid.UUID, activity_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass


@activity_router.delete("/{activity_id}")
async def delete_activity(org_id: uuid.UUID, activity_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass
