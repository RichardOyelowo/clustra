...
label_router = APIRouter(prefix="/orgs/{org_id}/teams/{team_id}/")


# ---------------- Project Label ------------------
@label_router.get("/projects/{proj_id}")
async def get_labels(org_id: uuid.UUID, team_id: uuid.UUID, proj_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass


@label_router.post("/projects/{proj_id}")
...
@label_router.get("/projects/{proj_id}/{label_id}")
...
@label_router.patch("/projects/{proj_id}/{label_id}")
...
@label_router.delete("/projects/{proj_id}/{label_id}")
...
# ------------------ Task Label ---------------------
@label_router.get("/projects/{proj_id}/{label_id}/task_label")
...
@label_router.post("/projects/{proj_id}/{label_id}/task_label/")
...
@label_router.get("/projects/{proj_id}/{label_id}/task_label/{task_id}")
async def get_task_label(org_id: uuid.UUID, team_id: uuid.UUID, proj_id: uuid.UUID, label_id: uuid.UUID, task_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass


@label_router.patch("/projects/{proj_id}/{label_id}/task_label/{task_id}")
async def edit_task_label(org_id: uuid.UUID, team_id: uuid.UUID, proj_id: uuid.UUID, label_id: uuid.UUID, task_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass


@label_router.delete("/projects/{proj_id}/{label_id}/task_label/{task_id}")
async def delete_task_label(org_id: uuid.UUID, team_id: uuid.UUID, proj_id: uuid.UUID, label_id: uuid.UUID, task_id: uuid.UUID, db: AsyncSession = Depends(db_session)):
    pass
